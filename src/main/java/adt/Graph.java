...
public class Graph<T>{
    ...
    {
        //makeStringEdge(v1,v2);
        return insertarArista(v1, v2, 1);
    }

    private void makeStringEdge(GraphNode<T> v1, GraphNode<T> v2){

        edgesList.add(v1.getTag()+" -> "+v2.getTag()+";");
    ...
    public HashMap<String, GraphNode<T>> getNodes(){
